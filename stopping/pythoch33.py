...
print(stemmer.stem('standardizes'), stemmer.stem('standardizes'))
print(stemmer.stem('national'), stemmer.stem('nation'))
print(stemmer.stem('adsentness'), stemmer.stem('adsently'))
print(stemmer.stem('tribalical'), stemmer.stem('tribalical'))
